...
mixin _$CurrentUser {
 ...
 String get id; String get email; String get username; bool get isEmailVerified;
...
@override
int get hashCode => Object.hash(runtimeType,id,email,username,isEmailVerified);

@override
String toString() {
  return 'CurrentUser(id: $id, email: $email, username: $username, isEmailVerified: $isEmailVerified)';
}
...
@useResult
$Res call({
 String id, String email, String username, bool isEmailVerified
});
...
/// Create a copy of CurrentUser
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? email = null,Object? username = null,Object? isEmailVerified = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String email,  String username,  bool isEmailVerified)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CurrentUser() when $default != null:
return $default(_that.id,_that.email,_that.username,_that.isEmailVerified);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String email,  String username,  bool isEmailVerified)  $default,) {final _that = this;
switch (_that) {
case _CurrentUser():
return $default(_that.id,_that.email,_that.username,_that.isEmailVerified);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String email,  String username,  bool isEmailVerified)?  $default,) {final _that = this;
switch (_that) {
case _CurrentUser() when $default != null:
return $default(_that.id,_that.email,_that.username,_that.isEmailVerified);case _:
  return null;
...
class _CurrentUser implements CurrentUser {
  const _CurrentUser({required this.id, required this.email, required this.username, required this.isEmailVerified});
...
/// Create a copy of CurrentUser
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? email = null,Object? username = null,Object? isEmailVerified = null,}) {
