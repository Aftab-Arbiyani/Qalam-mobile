...
mixin _$WriterSummary {
 ...
 String get username; String? get penName; String? get avatarKey; String? get bio; int get followersCount; int get piecesCount;/// True for a private account surfaced by search — findable (name only) but
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,username,penName,avatarKey,bio,followersCount,piecesCount,isPrivate);

@override
String toString() {
  return 'WriterSummary(username: $username, penName: $penName, avatarKey: $avatarKey, bio: $bio, followersCount: $followersCount, piecesCount: $piecesCount, isPrivate: $isPrivate)';
}
...
@useResult
$Res call({
 String username, String? penName, String? avatarKey, String? bio, int followersCount, int piecesCount, bool isPrivate
});
...
/// Create a copy of WriterSummary
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? username = null,Object? penName = freezed,Object? avatarKey = freezed,Object? bio = freezed,Object? followersCount = null,Object? piecesCount = null,Object? isPrivate = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String username,  String? penName,  String? avatarKey,  String? bio,  int followersCount,  int piecesCount,  bool isPrivate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WriterSummary() when $default != null:
return $default(_that.username,_that.penName,_that.avatarKey,_that.bio,_that.followersCount,_that.piecesCount,_that.isPrivate);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String username,  String? penName,  String? avatarKey,  String? bio,  int followersCount,  int piecesCount,  bool isPrivate)  $default,) {final _that = this;
switch (_that) {
case _WriterSummary():
return $default(_that.username,_that.penName,_that.avatarKey,_that.bio,_that.followersCount,_that.piecesCount,_that.isPrivate);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String username,  String? penName,  String? avatarKey,  String? bio,  int followersCount,  int piecesCount,  bool isPrivate)?  $default,) {final _that = this;
switch (_that) {
case _WriterSummary() when $default != null:
return $default(_that.username,_that.penName,_that.avatarKey,_that.bio,_that.followersCount,_that.piecesCount,_that.isPrivate);case _:
  return null;
...
class _WriterSummary extends WriterSummary {
  const _WriterSummary({required this.username, this.penName, this.avatarKey, this.bio, this.followersCount = 0, this.piecesCount = 0, this.isPrivate = false}): super._();
...
/// Create a copy of WriterSummary
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? username = null,Object? penName = freezed,Object? avatarKey = freezed,Object? bio = freezed,Object? followersCount = null,Object? piecesCount = null,Object? isPrivate = null,}) {
