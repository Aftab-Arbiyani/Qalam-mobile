/// Editor taxonomy repository (docs/40 §16, §23, §25) — cache-then-network for the
...
import '../datasources/editor_taxonomy_remote_data_source.dart';

class EditorTaxonomyRepositoryImpl implements EditorTaxonomyRepository {
  EditorTaxonomyRepositoryImpl(this._remote, this._cache);

  final EditorTaxonomyRemoteDataSource _remote;
