...
@ProviderFor(editorTaxonomyRemoteDataSource)
final editorTaxonomyRemoteDataSourceProvider =
    EditorTaxonomyRemoteDataSourceProvider._();

final class EditorTaxonomyRemoteDataSourceProvider
    extends
        $FunctionalProvider<
          EditorTaxonomyRemoteDataSource,
          EditorTaxonomyRemoteDataSource,
          EditorTaxonomyRemoteDataSource
        >
    with $Provider<EditorTaxonomyRemoteDataSource> {
  EditorTaxonomyRemoteDataSourceProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'editorTaxonomyRemoteDataSourceProvider',
        isAutoDispose: false,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$editorTaxonomyRemoteDataSourceHash();

  @$internal
  @override
  $ProviderElement<EditorTaxonomyRemoteDataSource> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  EditorTaxonomyRemoteDataSource create(Ref ref) {
    return editorTaxonomyRemoteDataSource(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(EditorTaxonomyRemoteDataSource value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<EditorTaxonomyRemoteDataSource>(
        value,
      ),
    );
  }
...
String _$editorTaxonomyRemoteDataSourceHash() =>
    r'70bf3ecfcd9b941684888a982196cee3df131f0a';

@ProviderFor(editorTaxonomyRepository)
final editorTaxonomyRepositoryProvider = EditorTaxonomyRepositoryProvider._();

final class EditorTaxonomyRepositoryProvider
    extends
        $FunctionalProvider<
          ...
          EditorTaxonomyRepository
        >
    with $Provider<EditorTaxonomyRepository> {
  EditorTaxonomyRepositoryProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'editorTaxonomyRepositoryProvider',
        isAutoDispose: false,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$editorTaxonomyRepositoryHash();

  @$internal
  @override
  $ProviderElement<EditorTaxonomyRepository> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  EditorTaxonomyRepository create(Ref ref) {
    return editorTaxonomyRepository(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(EditorTaxonomyRepository value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<EditorTaxonomyRepository>(value),
    );
  }
}

String _$editorTaxonomyRepositoryHash() =>
    r'e51734a685a0fa44583fe8073f2402c2b22aaaac';
