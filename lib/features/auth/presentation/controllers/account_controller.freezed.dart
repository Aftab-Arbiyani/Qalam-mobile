...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AccountState&&(identical(other.signingOut, signingOut) || other.signingOut == signingOut));
}


@override
int get hashCode => Object.hash(runtimeType,signingOut);

@override
String toString() {
  return 'AccountState(signingOut: $signingOut)';
}
...
/// Create a copy of AccountState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? signingOut = null,}) {
  return _then(_self.copyWith(
signingOut: null == signingOut ? _self.signingOut : signingOut // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool signingOut)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AccountState() when $default != null:
return $default(_that.signingOut);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool signingOut)  $default,) {final _that = this;
switch (_that) {
case _AccountState():
return $default(_that.signingOut);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool signingOut)?  $default,) {final _that = this;
switch (_that) {
case _AccountState() when $default != null:
return $default(_that.signingOut);case _:
  return null;
...
class _AccountState implements AccountState {
  const _AccountState({this.signingOut = false});
  

@override@JsonKey() final  bool signingOut;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AccountState&&(identical(other.signingOut, signingOut) || other.signingOut == signingOut));
}
...
/// Create a copy of AccountState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? signingOut = null,}) {
