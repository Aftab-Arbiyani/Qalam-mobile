...
/// piece, follow on a writer, and report. The only place these mutations touch the
/// wire. Returns the server's authoritative result (new count / state) or throws
/// [ApiException] for the repository to translate. No retries (docs/40 §13.5).
library;
...
import '../../domain/repositories/engagement_repository.dart' show LikeOutcome;
...
class EngagementRemoteDataSource {
  ...
  Future<void> report({
    ...
    ApiPaths.reports,
    body: <String, Object?>{
      'entityType': ReportEntityType.piece.wire,
      'entityId': pieceId,
      'reason': reason.wire,
